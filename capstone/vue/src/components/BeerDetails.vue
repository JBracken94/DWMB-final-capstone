...
export default {
  ...
  methods: {
    submitForm() {
      ...
      // so note you can acess the form data using the (this.beerName and this.beerType and this.beerDescription
      ...
      // take note i need to make 200 or 201 or 404  bascailly the sucesss and error situation 
